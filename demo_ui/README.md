...
4. [View Synthesis Protocol]: Click the `Print Generated Instructions` button to check the detailed SOP parameter plan generated by the LLM before orchestrating the real system.
5. [Archive Results]: Click the `Archive E2E Demonstration Report` button at the bottom of the page to save the output report to the `demo_reports` folder.
